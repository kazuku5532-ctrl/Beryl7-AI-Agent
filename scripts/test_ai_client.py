...
def main():
    ...
    # 1. Thu thập Telemetry & Anomaly thật từ Router
    ...
    print("[2/3] Khởi tạo Gemini 2.0 Flash AI Agent...")
    try:
        ai_agent = RouterAIAgent(api_key=args.api_key)
