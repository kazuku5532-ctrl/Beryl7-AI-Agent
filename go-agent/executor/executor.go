...
func (e *Executor) actionTuneNetworkPerformance(ctx context.Context, target string, params map[string]interface{}) error {
	...
	_ = runSystemCmd(ctx, "/sbin/uci", "set", "wireless.MT7993_1_2.muofdmadl_enable=1")
	_ = runSystemCmd(ctx, "/sbin/uci", "set", "wireless.MT7993_1_2.muofdmaul_enable=1")
	_ = runSystemCmd(ctx, "/sbin/uci", "set", "wireless.MT7993_1_2.mumimodl_enable=1")
	_ = runSystemCmd(ctx, "/sbin/uci", "set", "wireless.MT7993_1_2.mumimoul_enable=1")
	_ = runSystemCmd(ctx, "/sbin/uci", "set", "wireless.MT7993_1_2.vow_airtime_fairness_en=1")
	_ = runSystemCmd(ctx, "/sbin/uci", "set", "wireless.MT7993_1_2.vow_ex_en=1")
	_ = runSystemCmd(ctx, "/sbin/uci", "set", "wireless.MT7993_1_2.vow_bw_ctrl=0")
	_ = runSystemCmd(ctx, "/sbin/uci", "set", "wireless.MT7993_1_2.ht_bawinsize=256")
	_ = runSystemCmd(ctx, "/sbin/uci", "set", "wireless.MT7993_1_2.amsdu_num=8")
	_ = runSystemCmd(ctx, "/sbin/uci", "set", "wireless.rai0.ht_bawinsize=256")
	_ = runSystemCmd(ctx, "/sbin/uci", "set", "wireless.rai0.amsdu_num=8")
